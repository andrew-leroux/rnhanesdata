...
#' @description
#'
#' This package contains tools for processing the NHANES 2003-2004 and 2005-2006 waves' accelerometry data as well
#' as the resulting processed data. Specifically, the code
...
#'     accelerometry data for details on how exactly to reproduce all data in the package using the four functions below (create-all-processed-data).
#'
...
#'                 with one row per subejct-day, and seven rows per subject. This can either 1) process data that has been downlaoded locally; or 2) downlaod the data from the CDC.}
...
#'                 This function uses the \code{\link{weartime}} function from the accelerometry package to estimate weartime.
...
#'                 from both waves. The function has the option to return both adjusted and unadjusted survey weights. This function calculates both interview and examination survey weights.
...
#'            \itemize{
#'                \item{ALQ_C.XPT and ALQ_D.XPT}{ Alcohol consumption questionnaire data for the 2003-2004 and 2005-2006 waves, respectively.}
...
#'                \item{DIQ_C.XPT and DIQ_D.XPT}{ Diabetes questionnaire data for the 2003-2004 and 2005-2006 waves, respectively.}
#'                \item{MCQ_C.XPT and MCQ_D.XPT}{ Medical conditions questionnaire data for the 2003-2004 and 2005-2006 waves, respectively.}
#'                \item{PFQ_C.XPT and PFQ_D.XPT}{ Physical function questionnaire data for the 2003-2004 and 2005-2006 waves, respectively.}
#'                \item{SMQ_C.XPT and SMQ_D.XPT}{ Smoking status questionnaire data for the 2003-2004 and 2005-2006 waves, respectively.}
#'            }
#'      }
#'      \item{Linked mortality data}{
#'           \itemize{
