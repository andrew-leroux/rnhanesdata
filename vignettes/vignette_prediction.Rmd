...
rm(list=c("df_labs","df.act","df.act.m","df1","df2","p.pc","p.act","ind.pc1","ind.pc2"))
```
...
for(i in 1:length(s1)){
  auc_mat_adj$Variable[which(auc_mat_adj$Variable == s1[i])] <- s2[i]
  }
...
rm(list=c("inx_ls",
          ...
          paste0("exc_vars_",c("adj")),
          "i","n_folds","k_id"))
rm(list = "data_analysis")
rm(list= "data_analysis_svy_adj")
